...
public class ComunicadoModel {
    ...
    public ComunicadoModel(String cod_reg, String tipo, int icon, String nom_publicador, String fecha, String titulo, String descripcion, ArrayList<String> filedata) {
